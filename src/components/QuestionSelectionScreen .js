...
export default function QuestionSelectionScreen({ dispatch }) {
  const data = [
    {
  ...
  const handleSelection = (num) => {
    dispatch({ type: "selectNumQuestions", payload: num });
  ...
  return (
    <div className="question-selection">
      ...
      <button className="btn btn-ui" onClick={() => handleSelection(5)}>
        5 Questions
      </button>
      <button className="btn btn-ui" onClick={() => handleSelection(10)}>
        10 Questions
      </button>
      <button className="btn btn-ui" onClick={() => handleSelection(15)}>
        15 Questions
      </button>
    </div>
  );
